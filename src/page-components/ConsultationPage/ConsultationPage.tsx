  ...
  return (
    <>
      ...
      <section className={styles["consultation__sort-of-section"]}>
        <SortOfConsultation textOptions={{
      ...
      <section className={styles["consultation__green-content-section"]}>
        <GreenContentBlock content={"consultation_green_content"} revers={true} optionsForTextWithPhoto={{
          targets: ['на многие', 'аспекты', 'вашей', 'жизни.'],
          fontWeight: 700,
          colorText: "green"
        }} optionsForTextBelowPhoto={{
          targets: ['избежать', 'ошибок,', 'сэкономить', 'время', 'и деньги,'],
          fontWeight: 700,
          colorText: "white"
        }} />
      </section>
