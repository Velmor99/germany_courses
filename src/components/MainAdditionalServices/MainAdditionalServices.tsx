    ...
    <div className={cn(styles["services"])}>
      <div className={cn(styles["container"])}>
        ...
        <ul className={cn(styles["services__list"])}>
          <li className={cn(styles["services__list-item"], styles["services__list-item-first"])}>
          ...
          <li className={cn(styles["services__list-item"], styles["services__list-item-second"])}>
            <MainAdditionalServicesCard
          ...
          <li className={cn(styles["services__list-item"], styles["services__list-item-third"])}>
            <MainAdditionalServicesCard
          ...
          <li className={cn(styles["services__list-item"], styles["services__list-item-fourth"])}>
            <MainAdditionalServicesCard
          ...
          <li className={cn(styles["services__list-item"], styles["services__list-item-fifth"])}>
            <MainAdditionalServicesCard
          ...
          <li className={cn(styles["services__list-item"], styles["services__list-item-sixth"])}>
            <MainAdditionalServicesCard
          ...
          <li className={cn(styles["services__list-item"], styles["services__list-item-seventh"])}>
            <MainAdditionalServicesCard
