...
import LargeGreenWeIcon from "../../../public/common/large_green_we.svg";
import LargeWhiteWeIcon from "../../../public/common/large_white_we.svg";
...
export const FormComponent = ({
  ...
  const [isPhoneCorrect, setIsPhoneCorrect] = useState<{type: string, message: string} | null>(null)
  ...
  const onSubmit: SubmitHandler<IForm> = async (formData: IForm) => {
    ...
    const validatedNumber = validatePhoneNumber(String(formData.phone), country)
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      >
        ...
        <div className={cn(styles["form__phone-input"])}>
          <CountrySelect callback={changeCountry} className={styles["form__select"]} />
          <InputComponent
            type={"tel"}
        ...
        <div className={styles["form__we-icon"]}>
          {styleType === "green" ? <LargeWhiteWeIcon /> : <LargeGreenWeIcon />}
        </div>
      </div>
      {/* {isSuccess && (
