  ...
  return (
    <div className={cn(styles["banner"])}>
      <div className={cn(styles["banner__background-desktop"], {
        ...
        [styles["documents-background-desktop"]]: bannerName === "documents_banner",
        [styles["prepare-to-test-background-desktop"]]: bannerName === "prepare_to_test_banner",
        [styles["speaking-club-background-desktop"]]: bannerName === "speaking_club_banner",
        [styles["students-background-desktop"]]: bannerName === "students_banner"
      })}>
          ...
          <div className={cn(styles["container"])}>
            <div className={cn(styles["banner__content"])}>
              <div className={cn(styles["banner__background"], {
                ...
                [styles["documents-background"]]: bannerName === "documents_banner",
                [styles["prepare-to-test-background"]]: bannerName === "prepare_to_test_banner",
                [styles["speaking-club-background"]]: bannerName === "speaking_club_banner",
                [styles["students-background"]]: bannerName === "students_banner"
              })}>
              </div>
              <BannerContent
